...
class TestFunctional(_LibrosaMixin, unittest.TestCase):
    ...
    def test_create_fb(self):
        ...
        self._test_create_fb(n_mels=128, fmin=0.0, fmax=44100.0)
        self._test_create_fb(n_mels=128, fmin=2000.0, fmax=5000.0)
        self._test_create_fb(n_mels=80, fmin=0.0, fmax=8000.0)
        ...
        self._test_create_fb(norm="slaney")
        ...
        self._test_create_fb(n_mels=80, fmin=0.0, fmax=8000.0, norm="slaney")
        ...
        self._test_create_fb(n_mels=128, fmin=0.0, fmax=44100.0, mel_scale="slaney")
        self._test_create_fb(n_mels=128, fmin=2000.0, fmax=5000.0, mel_scale="slaney")
        self._test_create_fb(n_mels=80, fmin=0.0, fmax=8000.0, mel_scale="slaney")
